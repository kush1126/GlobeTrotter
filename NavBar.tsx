      ...
      <div className="max-w-6xl mx-auto px-6 py-3.5 flex items-center justify-between gap-6">
        ...
        {user ? (
          <div className="flex items-center gap-3 shrink-0">
            <Link
              to="/profile"
              className="flex items-center gap-2.5 pl-2 pr-3 py-1 rounded-full border border-paper-dim hover:border-route transition-colors group bg-paper"
              aria-label="Your profile"
            >
              <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-route to-route-light text-paper-pure flex items-center justify-center font-heading font-bold text-xs shadow-sm">
